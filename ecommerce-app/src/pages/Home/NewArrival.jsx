...
export default function NewArrival() {
  return (
    <section className=" px-4">
      ...
      <a
        href="/shop"
        class="inline-block border text-black px-8 py-3 rounded-full transition-all duration-300 hover:shadow-lg font-medium focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
