...
const ContactPage = () => {
  ...
  return (
    ...
    >
      <div className="min-h-screen bg-primary px-4 py-12 md:px-20">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-subtext mb-4">
            Get In Touch
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="flex items-center justify-center text-subtext text-black px-6 py-3 rounded-xl font-medium shadow-lg transition-all hover:shadow-pink-200 hover:translate-y-[-2px] w-full"
              >
